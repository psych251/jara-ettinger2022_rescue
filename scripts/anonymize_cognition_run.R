...
# Combine files 
path_to_files <- list.files(path = "PATH TO FILES", 
...
output_path_combined_data <- "PATH TO COMBINED DATA FILE"
write_csv(combined_df, here(output_path_combined_data))
  
# Read data
path_to_data = "PATH TO ORIGINAL DATA"
...
# Save data
output_path = "PATH TO ANONYMIZED DATA FILE"
